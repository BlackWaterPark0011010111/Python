...
Implement A CLI that shows the user available options of the coffee machine class (example: make late, show resources). NOTE: to do this you will have to implement a while loop
CLASS: Create a CoffeeMachine class that has the following attributes and methods:
...
money: Initial amount of money (in dollars). Methods/Functions:
init(self, water, milk, coffee_beans, money): Initialize the coffee machine with the specified resources.
