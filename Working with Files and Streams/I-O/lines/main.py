...
Your result should look like this: 5
...
rule.This text has been manipulated so that it only reads well if we print the odd lines first and then the even lines. Write some Python code that opens this file and prints first the odd lines and then the even lines.
Your result should look like this:
_3 May. Bistritz._--Left Munich at 8:35 P. M., on 1st May, arriving at
Vienna early next morning; should have arrived at 6:46, but train was an
hour late. Buda-Pesth seems a wonderful place, from the glimpse which I
...
Your result should look like this:
We left in pretty good time, and came after nightfall to Klausenburgh. 70
Task 6
