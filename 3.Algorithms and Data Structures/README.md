...
и подобный стек,в котором сохранялись все переменные разных функций- это стек.
...
Хеш-таблицы
О(n) и O(log n)- не одно и тоже.
Хеш-функция получает строку и возвращает число.она отображает строки на числа. и она должна {{{соответствовать требованиям:
